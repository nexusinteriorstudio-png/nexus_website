...
export function GallerySection() {
  ...
  const images = [
    { src: "/images/enhanced-Enscape_2025-02-13-10-52-59.png", alt: "The Bronze Loft — Open Concept" },
    { src: "/images/VISUAL RENDER (2).jpg", alt: "The Travertine Residence — Living Room" },
    { src: "/images/Enscape_2024-09-30-16-57-11.png", alt: "The Ivory Villa — Evening View" },
    { src: "/images/5.jpg", alt: "The Walnut Penthouse — Master Suite" },
  ];
  ...
  return (
    ...
    >
      {/* Section Header */}
      <div className="absolute top-0 left-0 right-0 z-20 px-6 pt-20 md:px-12 lg:px-20">
        <p className="text-xs uppercase tracking-[0.3em] text-white/50 mb-4">Project Highlights</p>
      </div>
        ...
        <div className="relative w-full max-w-5xl h-[70vh] md:h-[80vh]">
          {images.map((image, index) => {
            ...
            if (isLast) {
              ...
              const expandedScale = 1 + (easedFullscreenProgress * 0.3); // 1 to 1.8
